    ...
    <div className="gl-full-container">
      ...
      <div className="gl-profile-section">
        ...
        <div className="gl-profile-info-box">
          <p><span style={{ fontWeight: 500 }}>Hub Leader:</span> {sysAdminName}</p>
          <p><span style={{ fontWeight: 500 }}>Secretary name and phone no.</span> </p>
        </div>
      </div>
        ...
        <div className="gl-left-content">
          ...
          <div className="gl-card-grid">
            <div className="gl-card" onClick={() => navigate("/")}>
              <div className="gl-card-header"><Users className="gl-icon" /><p className="gl-title">Group info</p></div>
